...
#[derive(Debug)]
pub struct CheckerStyleProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CheckerStyleProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CheckerStyle processing");
    
    let mut processor = CheckerStyleProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CheckerStyleProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CheckerStyleProcessor::new(false);
